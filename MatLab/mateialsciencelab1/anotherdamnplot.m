...
categories.Composites = {'Glass fiber-reinforced epoxy', 'Borosilicate glass', 'Soda-lime glass', ...
                        'Sapphire', 'Magnesia (MgO)', 'Silica (SiO2)', 'Boron nitride nanotube (BNNT)', ...
                        'Graphite', 'Carbon nanotubes', 'Graphene', 'Porous carbon', 'Charcoal'};

% Combine all categories into one cell array
all_categories = {'Metals', 'Polymers', 'Composites'};
